...
if (avatarSection) {
    ...
    const additionalAvatars = [
        ["시나노", "SHINANO"], ["아이리", "AIRI", "avatar/airi.webp"], ["밀티나", "MILTINA", "avatar/miltina.webp"],
        ["쇼콜라", "CHOCOLAT", "avatar/chocolat.webp"], ["쉬폰", "CHIFFON", "avatar/chiffon.webp"], ["라임", "LIME", "avatar/lime.webp"],
        ["시오", "SHIO", "avatar/shio.webp"], ["신라", "SHINRA"], ["루미나", "LUMINA"],
        ["이치고", "ICHIGO", "avatar/ichigo.webp"], ["마야", "MAYA"], ["모에", "MOE", "avatar/moe.webp"],
        ["키펠", "KIPFEL", "avatar/kipfel.webp"], ["코마노", "KOMANO", "avatar/komano.webp"], ["한카", "HANKA", "avatar/hanka.webp"],
        ["미나세", "MINASE"], ["리에", "RIER", "avatar/rier.webp"], ["알루에", "ALUE", "avatar/alue.webp"],
